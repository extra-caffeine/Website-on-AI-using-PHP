  ...
  <body>
    ...
    <section class="site-section">
      <div class="container">
        <div class="row mb-4">
          <div class="col-md-6">
            <h2 class="mb-4">Category:Advantages & Disadvantages of AI</h2>
          </div>
        </div>
              ...
              <div class="col-md-12">
                ...
                <div class="post-entry-horzontal">
                  <a href="#">
                    ...
                    <span class="text">
                      <div class="post-meta">
                        <span class="category">	EMMPLOYMENT</span>
                        <span class="mr-2">Octuber 23,2018 </span> &bullet;
                        <span class="ml-2"><span class="fa fa-comments"></span> 3</span>
                      </div>
                      <h2>There’s a time coming for men to be enslaved by Robos</h2>
                    </span>
                  </a>
                </div>
                <!-- END post -->
